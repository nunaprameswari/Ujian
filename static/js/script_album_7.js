const music = new Audio('./static/songs/album_7/3.mp3');
...
const songs = [
    ...
    {
        id: '4',
        songName: `흥탄소년단 (Fun Boys) <br>
        <div class="album">In The Mood For Love pt.1 (2015)</div>`,
        poster: "./static/img/album/album_7.jpg",
    },
    {
        id: '5',
        songName: `Converse High <br>
        <div class="album">In The Mood For Love pt.1 (2015)</div>`,
        poster: "./static/img/album/album_7.jpg",
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        music.src = `./static/songs/album_7/${index}.mp3`;
        music.play();
        masterPlay.classList.remove('bx-play');
        masterPlay.classList.add('bx-pause');
        download_music.href = `./static/songs/album_7/${index}.mp3`;
