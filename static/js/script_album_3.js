const music = new Audio('./static/songs/album_3/4.mp3');

const songs = [
    {
        id: '1',
        songName: `Boy In Luv (상남자) <br>
        <div class="album">Skool Luv Affair (2014))</div>`,
        poster: "./static/img/album/album_3.jpg",
    },
    {
        id: '2',
        songName: `Where Did You Come From (어디에서왔는지) <br>
        <div class="album">Skool Luv Affair (2014))</div>`,
        poster: "./static/img/album/album_3.jpg",
    },
    {
    ...
    {
        id: '7',
        songName: `BTS Cypher PT.2: Triptych <br>
        <div class="album">Skool Luv Affair (2014)</div>`,
        poster: "./static/img/album/album_3.jpg",
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        music.src = `./static/songs/album_3/${index}.mp3`;
        music.play();
        masterPlay.classList.remove('bx-play');
        masterPlay.classList.add('bx-pause');
        download_music.href = `./static/songs/album_3/${index}.mp3`;
