const music = new Audio('./static/songs/album_5/1.mp3');

const songs = [
    {
        id: '1',
        songName: `THE STARS <br>
        <div class="album">WAKE UP</div>`,
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        music.src = `./static/songs/album_5/${index}.mp3`;
        music.play();
        masterPlay.classList.remove('bx-play');
        masterPlay.classList.add('bx-pause');
        download_music.href = `./static/songs/album_5/${index}.mp3`;
