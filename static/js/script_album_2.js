const music = new Audio('./static/songs/album_2/1.mp3');

const songs = [
    {
        id: '1',
        songName: `N.O <br>
        <div class="album">O!RUL8,2? (2013)</div>`,
    ...
    {
        id: '3',
        songName: `If I Ruled The World <br>
        <div class="album">O!RUL8,2? (2013)</div>`,
        poster: "./static/img/album/album_2.png",
    },
    {
    ...
    {
        id: '6',
        songName: `진격의 방탄 (Attack On Bangtan)
        <div class="album">O!RUL8,2? (2013)</div>`,
        poster: "./static/img/album/album_2.png",
    },
    {
        id: '7',
        songName: `팔도강산 (Paldogangsan) <br>
        <div class="album">O!RUL8,2? (2013)</div>`,
        poster: "./static/img/album/album_2.png",
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        music.src = `./static/songs/album_2/${index}.mp3`;
        music.play();
        masterPlay.classList.remove('bx-play');
        masterPlay.classList.add('bx-pause');
        download_music.href = `./static/songs/album_2/${index}.mp3`;
