const music = new Audio('./static/songs/album_9/1.mp3');

const songs = [
    {
        id: '1',
        songName: `Blood Sweat and Tears <br>
        <div class="album">WINGS (2016)</div>`,
        poster: "./static/img/album/album_9.jpg",
    },
    {
        id: '2',
        songName: `Am I Wrong <br>
        <div class="album">WINGS (2016)</div>`,
        poster: "./static/img/album/album_9.jpg",
    },
    {
        id: '3',
        songName: `21st Century Girls (21세기 소녀) <br>
        <div class="album">WINGS (2016)</div>`,
        poster: "./static/img/album/album_9.jpg",
    },
    {
        id: '4',
        songName: `Two! Three! (Hoping for Better Days) (둘! 셋! (그래도 좋은 날이 더 많기를)<br>
        <div class="album">WINGS (2016)</div>`,
        poster: "./static/img/album/album_9.jpg",
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        music.src = `./static/songs/album_9/${index}.mp3`;
        music.play();
        masterPlay.classList.remove('bx-play');
        masterPlay.classList.add('bx-pause');
        download_music.href = `./static/songs/album_9/${index}.mp3`;
