const music = new Audio('./static/songs/album_10/9.mp3');

const songs = [
    {
        id: '1',
        songName: `Begin (Jungkook Solo) <br>
        <div class="album">Wings , You Never Walk Alone (2017)</div>`,
        poster: "./static/img/album/album_10.jpg",
    },
    {
        id: '2',
        songName: `Lie (Jimin Solo) <br>
        <div class="album">Wings , You Never Walk Alone (2017)</div>`,
        poster: "./static/img/album/album_10.jpg",
    },
    {
        id: '3',
        songName: `Stigma (Taehyung Solo) <br>
        <div class="album">Wings , You Never Walk Alone (2017)</div>`,
        poster: "./static/img/album/album_10.jpg",
    },
    {
        id: '4',
        songName: `First Love (Suga Solo) <br>
        <div class="album">Wings , You Never Walk Alone (2017)</div>`,
        poster: "./static/img/album/album_10.jpg",
    },
    {
        id: '5',
        songName: `Reflection (Rap Monster Solo) <br>
        <div class="album">Wings , You Never Walk Alone (2017)</div>`,
        poster: "./static/img/album/album_10.jpg",
    },
    {
        id: '6',
        songName: `Mama (Jhope Solo) <br>
        <div class="album">Wings , You Never Walk Alone (2017)</div>`,
        poster: "./static/img/album/album_10.jpg",
    },
    {
    ...
    {
        id: '10',
        songName: `Not Today <br>
        <div class="album">Wings , You Never Walk Alone (2017)</div>`,
        poster: "./static/img/album/album_10.jpg",
    },
    {
        id: '11',
        songName: `A Supplementary Story : You Never Walk Alone <br>
        <div class="album">Wings , You Never Walk Alone (2017)</div>`,
        poster: "./static/img/album/album_10.jpg",
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        music.src = `./static/songs/album_10/${index}.mp3`;
        music.play();
        masterPlay.classList.remove('bx-play');
        masterPlay.classList.add('bx-pause');
        download_music.href = `./static/songs/album_10/${index}.mp3`;
