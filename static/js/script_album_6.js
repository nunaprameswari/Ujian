const music = new Audio('./static/songs/album_6/2.mp3');

const songs = [
    {
        id: '1',
        songName: `Danger -Japanese Ver.- <br>
        <div class="album">Danger [Japanese]</div>`,
        poster: "./static/img/album/album_6.jpg",
    },
    {
        id: '2',
        songName: `進撃の防弾(SONPUB REMIX) <br>
        <div class="album">Danger [Japanese]</div>`,
        poster: "./static/img/album/album_6.jpg",
    },
    {
        id: '3',
        songName: `MISS RIGHT -Japanese Ver.- <br>
        <div class="album">Danger [Japanese]</div>`,
        poster: "./static/img/album/album_6.jpg",
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        music.src = `./static/songs/album_6/${index}.mp3`;
        music.play();
        masterPlay.classList.remove('bx-play');
        masterPlay.classList.add('bx-pause');
        download_music.href = `./static/songs/album_6/${index}.mp3`;
