const music = new Audio('./static/songs/yoongi/6.mp3');

const songs = [
    {
        id: '1',
        songName: `Interlude: Set Me Free <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/set_me.jpg",
    },
    {
        id: '2',
        songName: `People <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/people.jpg",
    },
    {
        id: '3',
        songName: `Strange <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/strange.jpg",
    },
    {
        id: '4',
        songName: `What Do You Think? <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/do_you_think.jpg",
    },
    {
        id: '5',
        songName: `Moonlight <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/moonlight.jpg",
    },
    {
        id: '6',
        songName: `AMYGDALA <br>
        <div class="album">D-DAY (2023) -C (cd2)-</div>`,
        poster: "./static/img/yoongi/amygdala.jpg",
    },
    {
        id: '7',
        songName: `28 <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/28.jpg",
    },
    {
        id: '8',
        songName: `Daechwita <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/daechwita.jpg",
    },
    {
        id: '9',
        songName: `People Pt.2 (feat. IU) <br>
        <div class="album">D-Day (2023)</div>`,
        poster: "./static/img/yoongi/people_iu.jpg",
    },
    {
        id: '10',
        songName: `Haegum <br>
        <div class="album">D-Day (2023)</div>`,
        poster: "./static/img/yoongi/haegum.jpg",
    },
    {
        id: '11',
        songName: `Burn It <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/burn_it.jpg",
    },
    {
        id: '12',
        songName: `D-Day <br>
    ...
    {
        id: '13',
        songName: `Dear My Friend <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/dear_my.jpg",
    },
    {
        id: '14',
        songName: `Interlude : Dawn <br>
        <div class="album">D-Day (2023)</div>`,
        poster: "./static/img/yoongi/dawn.jpg",
    },
    {
        id: '15',
        songName: `Life Goes ON <br>
        <div class="album">Be (2020)</div>`,
        poster: "./static/img/yoongi/life.jpg",
    },
    {
        id: '16',
        songName: `SDL <br>
        <div class="album">D-Day (2023)</div>`,
        poster: "./static/img/yoongi/dsl.jpeg",
    },
    {
        id: '17',
        songName: `Snooze <br>
    ...
    },
    {
        ...
        songName: `Honsool <br>
        <div class="album">D-2 (2020)</div>`,
        poster: "./static/img/yoongi/honsool.jpg",
    },
]
